...
int RTCDS3231::Displaytime() {
	...
	cout<<endl;
	cout << "The RTC time is hh:mm:ss::" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[2]) <<":"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[1])<<":"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[0])<<endl;
	cout << "The RTC date is dd/mm/yy:" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[4]) <<"/"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[5]&0x7F)<<"/"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[6])<<endl;
	cout << "The Alarm 1 time is Sec:Min:Hr::" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[9]&0x7F) <<":"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[8]&0x7F)<<":"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[7]&0x7F)<<endl;
	cout << "The Alarm 1 date is:" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[10]&0x3F)<<endl;
	cout << "The Alarm 2 time is Min:Hr::" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[12]&0x7F)<<":"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[11])<<endl;
	cout << "The Alarm 2 date is:" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[13]&0x3F)<<endl;
	//cout << "The Control and status are:" <<setw(2)<<setfill('0')<<this->bcdToDec(buffer[15]) <<"/"<<setw(2)<<setfill('0')<<this->bcdToDec(buffer[14])<<endl;
	return 0;
}
